...
.logo{font-size:28px;font-weight:900;color:#00ff99;letter-spacing:2px;text-shadow:0 0 10px #00ff99;}
.slogan{font-size:14px;color:#d4fcdc;}
form{background:rgba(0,50,20,0.8);padding:12px;border-radius:10px;max-width:420px;margin:auto;}
label{display:block;margin-top:8px;font-size:14px;}
input, select, button{width:100%;padding:8px;margin-top:5px;border-radius:6px;border:none;background:#114422;color:#ffffff;font-size:14px;}
button{background:#00aa55;cursor:pointer;font-weight:600;margin-top:10px;}
button:hover{opacity:0.9;}
button.btn-danger{background:#cc3333;}
button.btn-danger:hover{opacity:0.9;}
table{width:100%;border-collapse:collapse;margin-top:15px;background:rgba(0,50,20,0.8);}
th, td{padding:6px;text-align:center;font-size:12px;border-bottom:1px solid rgba(255,255,255,0.1);}
th{color:#00ff99;}
...
select#mesFiltro, select#anoFiltro{width:auto;margin:10px 5px;display:inline-block;background:#114422;border:none;border-radius:6px;padding:6px;color:#ffffff;}
...
for(let a=2025;a<=2050;a++){const opt=document.createElement('option'); opt.value=a; opt.textContent=a; anoSel.appendChild(opt);}
document.getElementById('verMes').onclick=()=>{const m=Number(mesSel.value); const a=Number(anoSel.value); if(!m||!a)return alert("Selecione mês e ano."); atualizarUI(m,a);};
